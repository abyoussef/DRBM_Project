* **rbm.py** a python class that implements an RBM. It supports the binary and gaussion type of RBMs. We added to it another type, in order to include the Replicated Softmax Model of RBMs.
